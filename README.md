Política de Privacidade do aplicativo URL Shortener
...
O aplicativo utiliza apenas acesso à internet para comunicação com a API de encurtamento e não solicita permissões sensíveis como câmera, localização, contatos ou armazenamento externo.
